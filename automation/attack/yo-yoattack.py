...
ATTACK_CONCURRENCY = 310            # Pod da scale aos 51, mas aumentar este valor mais so para ter a certez que da scale up  (MUDASTE AQUI PARA TER A CERTEZA QUE DA ESTAVA 265)
