...
def compute_cost_rate(intervals):
    ...
    produce two lists: times at interval boundaries, and the rate of cost change ($/min).
    """
    ...
    # Compute delta rate between consecutive points
    x_times = []
    rates   = []
...
def plot_cost_rate(x, y, output_path):
    """
    Generate and save a step-plot of cost change rate over time.
    """
